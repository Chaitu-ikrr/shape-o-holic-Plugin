      ...
      <div id="on-hover" className={styles.onHover}>
        ...
        <div className={styles.buttonContainer}>
          <div id="topButtons" className={styles.topButtons}>
            <DownloadButton variant="png" onClick={handleDownload("png")} />
            <DownloadButton variant="svg" onClick={handleDownload("svg")} />
          </div>
          <div id="bottomButtons" className={styles.bottomButtons}>
            <CopyButton variant="png" onClick={handleCopy("png")} />
            <CopyButton variant="svg" onClick={handleCopy("svg")} />
          </div>
        </div>
      </div>
    </div>
